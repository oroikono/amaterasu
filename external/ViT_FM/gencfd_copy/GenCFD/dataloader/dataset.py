...
class TrainingSetBase:
    ...
    def __init__(
        ...
        if move_to_local_scratch:
            ...
            print("COPYING DATA TO LOCAL SCRATCH")
        ...
        # Load Dataset
        #TMP::::
        ###file_path = os.path.join(file_system["origin"], file_system["file_name"])

        #file_path = "/cluster/work/math/camlab-data/synthetic/ATM-MSC_3D_moist.nc"
    ...
    def file_on_local_scratch(self, file_name: str, origin: str) -> str:
        ...
        if os.path.exists(tmpdir_file_path) and os.path.getsize(tmpdir_file_path) > 10 * 1024**3:
    ...
    def normalize_input(self, u_: Union[array, Tensor]) -> Union[array, Tensor]:
        #print(self.mean_training_input, self.std_training_input, "INP")
    ...
    def normalize_output(self, u_: Union[array, Tensor]) -> Union[array, Tensor]:
        #print(self.mean_training_input, self.std_training_input, "INP")
        #print(self.mean_training_output, self.std_training_output, "OUT")
        #time.sleep
