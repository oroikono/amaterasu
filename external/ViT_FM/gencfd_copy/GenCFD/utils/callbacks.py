...
class TrainStateCheckpoint(Callback):
    ...
    def on_train_begin(self, trainer: Trainer) -> None:
        ...
        if checkpoint_path:
            ...
            trainer.model.denoiser.load_state_dict(checkpoint["model_state_dict"], strict=False)
    ...
    def _save_checkpoint(
        ...
        checkpoint = {
            ...
            "lr_update_step": getattr(trainer, "_lr_update_step", step),
            "grad_accum_counter": getattr(trainer, "_grad_accum_counter", 0),
            "scaler_state_dict": (
